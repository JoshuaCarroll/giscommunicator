...
namespace gisreporter_
{
    public class WinlinkMessage
    {
        ...
        public WinlinkMessage(string messageBody, string filepath)
        {
            ...
            if ((MessageXML != null) && (MessageXML.Trim() != ""))
            {
                    ...
                    catch
                    {
                        ...
                        catch
                        {
                            ...
                            catch
                            {
                                ...
                                Console.WriteLine("** Unable to find location coordinates in " + UniqueID);
                            }
                        }
                    }
                ...
                {
                    Console.WriteLine("** Exeception thrown while parsing XML data in " + UniqueID + ": " + ex);
                }
            }
        }
